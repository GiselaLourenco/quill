...
/**
 * Botão flutuante de adicionar livro, no canto inferior direito.
 *
 * Saiu do cabeçalho: lá era um alvo de 40px no topo direito, o ponto mais
 ...
 * dentro dele recebe, senão a faixa invisível engoliria cliques na estante.
 */
export function BotaoAdicionarLivro() {
  return (
    <div
